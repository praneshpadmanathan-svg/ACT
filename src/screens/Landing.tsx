...
import { RealmOpening } from '@/components/RealmOpening';
/* The landing page.
...
export function Landing() {
  ...
  const { continueAsGuest, progress, hasStarted } = useStore();
  ...
  return (
    <div className="min-h-dvh">
      <header className="realm-landing-header absolute inset-x-0 top-0 z-30">

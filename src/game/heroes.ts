...
export const HEROES: Hero[] = [
  {
    ...
    skin: '#f0cfae', skinShade: '#d9ac82',
    hair: '#3b2a1c', hairStyle: 'crop',
    cloak: '#5fa86b', cloakShade: '#3d7248',
    build: 'even',
  },
  {
    id: 'wren',
    ...
    skin: '#8a5a3b', skinShade: '#6b432a',
    hair: '#1c1410', hairStyle: 'locs',
    cloak: '#4f9dc9', cloakShade: '#2f6b8e',
    build: 'slight',
  },
  {
    id: 'juniper',
    ...
    skin: '#e2ad83', skinShade: '#c48a5f',
    hair: '#6b2f1a', hairStyle: 'braid',
    cloak: '#a8402f', cloakShade: '#7d2f22',
    build: 'even',
  },
  {
    id: 'kesh',
    ...
    skin: '#5d3a24', skinShade: '#432818',
    hair: '#120d0a', hairStyle: 'curls',
    cloak: '#d9a441', cloakShade: '#a97d24',
    build: 'broad',
  },
  {
    id: 'noor',
    ...
    skin: '#c98f62', skinShade: '#a56e45',
    hair: '#241812', hairStyle: 'wrap',
    cloak: '#7a4fd0', cloakShade: '#573596',
    build: 'even',
  },
  {
    id: 'sable',
    ...
    skin: '#4a2c1a', skinShade: '#331c0f',
    hair: '#0f0b08', hairStyle: 'braid',
    cloak: '#3f7d47', cloakShade: '#2a5730',
    build: 'slight',
  },
  {
    id: 'linden',
    ...
    skin: '#fadfc4', skinShade: '#e3bd99',
    hair: '#c9a24a', hairStyle: 'wave',
    cloak: '#d2703a', cloakShade: '#a24f22',
    build: 'broad',
  },
  {
    id: 'io',
